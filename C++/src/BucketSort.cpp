...
void BucketSort :: countingSort(int array[], int size) {
...
void BucketSort :: bucket_sort(int v[],int tam){
    BucketSort b[num_bucket];
    int i,j,k;
...
void BucketSort :: imprimir(int v[], int tam){
